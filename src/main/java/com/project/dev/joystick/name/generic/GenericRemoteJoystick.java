/*
 * @fileoverview {GenericRemoteJoystick} se encarga de realizar tareas especificas.
 *
 * @version             1.0
 *
 ...
 *
 * @History v1.0 --- La implementacion de {GenericRemoteJoystick} fue realizada el 31/07/2022.
 * @Dev - La primera version de {GenericRemoteJoystick} fue escrita por Dyson A. Parra T.
 */
...
/**
 * FIXME: Definición de {@code GenericRemoteJoystick}. Contiene las operaciones y definiciones
...
public abstract class GenericRemoteJoystick extends GenericJoystick {
    ...
    /**
     * TODO: Definición de {@code GenericRemoteJoystick}.
     *
    ...
    /**
     * FIXME: Definición de {@code setServerIpAddress}. Agrega dirección ip del servidor donde se va
    ...
    /**
     * FIXME: Definición de {@code setServerPort}. Escoge el puerto de conexión ya sea del servidor
